...
/**
 * <p>
 * The view is used to setup the UI elements, serves as taking the input values
 * and interact with controller to calculate the Beta function
 * </p>
 * 
...
public class View extends JFrame {
	...
	public View() {
		 ...
		 */
		notice = new JLabel(
				"If the numbers are large(even two digit) the result value will be negligible, which is rounded off to 0 upto certain decimal points");
		...
		button = new JButton("Calculate Beta Value");
		...
		/**
		 * <p>
		 * Adding the UI elements to JFrame panel
		 * </p>
		 */
	...
	/**
	 * <p>
	 * The method getNumOne returns the first input number
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * The method getNumOne returns the second input number
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * This method setResult sets the result value to UI
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * The method resultListener handles the action for the button click
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * The method displayError is used to display error messages on UI
	 * </p>
	 * 
