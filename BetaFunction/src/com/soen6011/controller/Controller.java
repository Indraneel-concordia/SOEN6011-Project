...
import com.soen6011.model.Model;
import com.soen6011.view.View;

/**
 * <p>
 * The Controller class serves as the interaction between the Model and the View
 * class.
 * </p>
 * 
...
public class Controller {
	...
	/**
	 * <p>
	 * This is the Controller constructor to set up view and model objects.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * The BetaListener class implements the ActionListener class and overrides the
	 * actionPermormed method to act on events.
	 * </p>
	 * 
	...
	class BetaListener implements ActionListener {
		...
		/**
		 * <p>
		 * The actionPerformed methods helps interaction between the view and model and
		 * facilitates the calculation of Beta function.
		 * </P>
		 */
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				if (numOne > 99 || numTwo > 99) {
					view.displayError("Please enter numbers below 100");
					System.exit(0);
				}
